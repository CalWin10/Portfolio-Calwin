...
//#region node_modules/vanta/dist/vanta.halo.min.js
var require_vanta_halo_min = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	(function(e, t) {
		...
		e.r(t), e.d(t, { default: () => f }), Number.prototype.clamp = function(e, t) {
		...
		s.VantaBase = class {
			constructor(e = {}) {
				...
				if (this.options = Object.assign({
					...
					scale: 1,
					scaleMobile: 1
				}, t), (e instanceof HTMLElement || "string" == typeof e) && (e = { el: e }), Object.assign(this.options, e), this.options.THREE && (o = this.options.THREE), this.el = this.options.el, null == this.el) r("Instance needs \"el\" param!");
				...
				try {
					...
					r("Init error", e), this.renderer && this.renderer.domElement && this.el.removeChild(this.renderer.domElement), this.options.backgroundColor && (console.log("[VANTA] Falling back to backgroundColor"), this.el.style.background = (a = this.options.backgroundColor, "number" == typeof a ? "#" + ("00000" + a.toString(16)).slice(-6) : a));
					return;
				}
		...
		class u extends h {
			...
			onInit() {
				const e = {
					...
					format: l.RGBFormat
				}, t = this.width * window.devicePixelRatio / this.scale, i = this.height * window.devicePixelRatio / this.scale;
				this.bufferTarget = new l.WebGLRenderTarget(t, i, e), this.bufferFeedback = new l.WebGLRenderTarget(t, i, e);
			}
			initBasicShader(e, t) {
				super.initBasicShader(e, t), this.uniforms.iBuffer = {
					type: "t",
			...
			onResize() {
				if (this.bufferTarget) {
					const e = this.width * window.devicePixelRatio / this.scale, t = this.height * window.devicePixelRatio / this.scale;
